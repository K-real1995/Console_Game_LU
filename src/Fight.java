...
public class Fight {
    ...
    public static String Fight(LinkedList<HordeUnit> arg1, LinkedList<AllianceUnit> arg2) {
        do {
            ...
            if (randomAllianceFighter.hp <= 0) {
                System.out.println(randomAllianceFighter.name + " Мертв");
                arg2.remove(randomAllianceFighter);
            }
            randomAllianceFighter.attack(randomHordeFighter);
            if (randomHordeFighter.hp <= 0) {
                System.out.println(randomHordeFighter.name + " Мертв");
